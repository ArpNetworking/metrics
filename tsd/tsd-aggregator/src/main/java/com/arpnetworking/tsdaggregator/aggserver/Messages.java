...
public final class Messages {
  ...
  public interface AggregationRecordOrBuilder
    ...
    /**
     * <code>optional int32 raw_sample_count = 8;</code>
     */
    boolean hasRawSampleCount();
    /**
     * <code>optional int32 raw_sample_count = 8;</code>
     */
  ...
  public static final class AggregationRecord extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 64: {
              ...
              rawSampleCount_ = input.readInt32();
              break;
            }
          }
        }
    ...
    // optional int32 raw_sample_count = 8;
    public static final int RAW_SAMPLE_COUNT_FIELD_NUMBER = 8;
    private int rawSampleCount_;
    /**
     * <code>optional int32 raw_sample_count = 8;</code>
     */
    public boolean hasRawSampleCount() {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000040) == 0x00000040)) {
        output.writeInt32(8, rawSampleCount_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000040) == 0x00000040)) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(8, rawSampleCount_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSerializedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      public com.arpnetworking.tsdaggregator.aggserver.Messages.AggregationRecord buildPartial() {
        ...
        result.rawSampleCount_ = rawSampleCount_;
        result.bitField0_ = to_bitField0_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.arpnetworking.tsdaggregator.aggserver.Messages.AggregationRecord other) {
        ...
        if (other.hasRawSampleCount()) {
          setRawSampleCount(other.getRawSampleCount());
        }
        this.mergeUnknownFields(other.getUnknownFields());
        return this;
      }
  ...
  bitField0_ |= 0x00000010;
       ...
       * <code>optional int32 raw_sample_count = 8;</code>
       */
      public Builder setRawSampleCount(int value) {
        bitField0_ |= 0x00000080;
        rawSampleCount_ = value;
        onChanged();
        return this;
      }
      /**
       * <code>optional int32 raw_sample_count = 8;</code>
       */
      public Builder clearRawSampleCount() {
        bitField0_ = (bitField0_ & ~0x00000080);
        rawSampleCount_ = 0;
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\007 \003(\001B\002\020\001\022\030\n\020raw_sample_count\030\010 \001(\005B+\n)" +
      "com.arpnetworking.tsdaggregator.aggserve" +
      "r"
    };
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_tsdaggregator_aggserver_AggregationRecord_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_tsdaggregator_aggserver_AggregationRecord_descriptor,
              new java.lang.String[] { "Service", "Metric", "Statistic", "Period", "PeriodStart", "StatisticValue", "StatisticSamples", "RawSampleCount", });
          return null;
        }
      };
