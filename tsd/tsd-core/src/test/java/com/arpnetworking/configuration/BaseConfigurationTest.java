...
public class BaseConfigurationTest {
    ...
    public void testGetPropertyAsFloatWithDefaultExists() {
        final Configuration configuration = TestConfiguration.create(
                "foo", "3.14");
        final float value = configuration.getPropertyAsFloat("foo", 6.28f);
        Assert.assertEquals(3.14f, value, 0.001);
    }
    ...
    public void testGetPropertyAsFloatWithDefaultMissing() {
        final Configuration configuration = TestConfiguration.create();
        final float value = configuration.getPropertyAsFloat("foo", 6.28f);
        Assert.assertEquals(6.28f, value, 0.001);
    }
    ...
    public void testGetPropertyAsFloatWithDefaultInvalid() {
        final Configuration configuration = TestConfiguration.create(
                "foo", "ABC");
        configuration.getPropertyAsFloat("foo", 6.28f);
    }
    ...
    public void testGetPropertyAsDoubleWithDefaultExists() {
        final Configuration configuration = TestConfiguration.create(
                "foo", "3.14");
        final double value = configuration.getPropertyAsDouble("foo", 6.28d);
        Assert.assertEquals(3.14d, value, 0.001);
    }
    ...
    public void testGetPropertyAsDoubleWithDefaultMissing() {
        final Configuration configuration = TestConfiguration.create();
        final double value = configuration.getPropertyAsDouble("foo", 6.28d);
        Assert.assertEquals(6.28d, value, 0.001);
    }
    ...
    public void testGetPropertyAsDoubleWithDefaultInvalid() {
        final Configuration configuration = TestConfiguration.create(
                "foo", "ABC");
        configuration.getPropertyAsDouble("foo", 6.28d);
    }
